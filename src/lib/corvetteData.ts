...
export const PARTS: PartDefinition[] = [
  ...
  // Hull Connector
  {
    id: "ballast-tank",
    name: "Ballast Tank",
    category: "Hull Connector",
    maxCount: 6,
    w: 1,
    h: 1,
    color: "#4b5563",
    description: "Connector ballast unit for joining hull segments.",
  },
  {
    id: "bolted-joint",
    name: "Bolted Joint",
    ...
    h: 1,
    color: "#374151",
    description: "Bolted reinforcement joint for hull transitions.",
  },
  {
    id: "coolant-distributor",
    ...
    h: 1,
    color: "#1f2937",
    description: "Cooling manifold connector between modules.",
  },
  {
    id: "ducting-joint",
    name: "Ducting Joint",
    ...
    h: 1,
    color: "#111827",
    description: "Duct connector for airflow and system routing.",
  },
  {
    id: "fuel-cell",
    name: "Fuel Cell",
    ...
    h: 1,
    color: "#0f172a",
    description: "Fuel transfer node used in connector paths.",
  },
  {
    id: "girder-array",
    name: "Girder Array",
    ...
    h: 1,
    color: "#334155",
    description: "Structural girder connector array.",
  },
  // Hull Attachment
  {
    id: "cargo-box",
    name: "Cargo Box",
    category: "Hull Attachment",
    maxCount: 8,
    w: 1,
    h: 1,
    color: "#78350f",
    description: "External cargo box attachment.",
  },
  {
    id: "cargo-capsule",
    name: "Cargo Capsule",
    ...
    h: 1,
    color: "#92400e",
    description: "Capsule-style exterior cargo attachment.",
  },
  {
    id: "cargo-pod",
    name: "Cargo Pod",
    ...
    h: 1,
    color: "#b45309",
    description: "Modular external cargo pod.",
  },
  {
    id: "cargo-rack",
    name: "Cargo Rack",
    ...
    h: 1,
    color: "#d97706",
    description: "Rack-mounted exterior storage unit.",
  },
  {
    id: "cargo-sphere",
    name: "Cargo Sphere",
    ...
    h: 1,
    color: "#ea580c",
    description: "Spherical external storage capsule.",
  },
  {
    id: "waste-disposal",
    name: "Waste Disposal",
    ...
    h: 1,
    color: "#9a3412",
    description: "Exterior waste disposal attachment.",
  },
  {
    id: "hull-vents",
    name: "Hull Vents",
    ...
    h: 1,
    color: "#7c2d12",
    description: "Vent cluster for external hull plating.",
  },
  // Window
  {
    id: "panelled-window",
    ...
    h: 1,
    color: "#38bdf8",
    description: "Panelled observation window segment.",
  },
  {
    id: "rounded-window",
    name: "Rounded Window",
    ...
    h: 1,
    color: "#0ea5e9",
    description: "Rounded observation window segment.",
  },
  {
    id: "seamless-window",
    ...
    h: 1,
    color: "#0284c7",
    description: "Seamless observation window segment.",
  },
  // Interior
  {
    id: "bunk-beds",
    ...
    h: 1,
    color: "#a78bfa",
    description: "Crew sleeping quarters decoration module.",
  },
  {
    id: "crew-berth",
    name: "Crew Berth",
    ...
    h: 1,
    color: "#8b5cf6",
    description: "Interior crew berth furnishing module.",
  },
  {
    id: "living-wall",
    name: "Living Wall",
    ...
    h: 1,
    color: "#7c3aed",
    description: "Decorative living wall interior panel.",
  },
  {
    id: "medi-pod",
    name: "Medi-Pod",
    ...
    h: 1,
    color: "#6d28d9",
    description: "Medical pod interior utility decoration.",
  },
  {
    id: "refiner-unit",
    name: "Refiner Unit",
    ...
    h: 1,
    color: "#5b21b6",
    description: "Compact interior refining unit.",
  },
  {
    id: "air-purifier",
    name: "Air Purifier",
    ...
    h: 1,
    color: "#4c1d95",
    description: "Life-support air purifier interior module.",
  },
  {
    ...
    h: 1,
    color: "#581c87",
    description: "Interior communications receiver assembly.",
  },
  {
    id: "mission-radar",
    name: "Mission Radar",
    ...
    h: 1,
    color: "#701a75",
    description: "Interior mission-tracking radar console.",
  },
  {
    id: "radar-dome",
    name: "Radar Dome",
    ...
    h: 1,
    color: "#86198f",
    description: "Interior radar dome display module.",
  },
  {
    id: "nutrition-unit",
    name: "Nutrition Unit",
    ...
    h: 1,
    color: "#a21caf",
    description: "Galley nutrition preparation unit.",
  },
  // Reactor
  {
